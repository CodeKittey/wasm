...
function integrateWasmJS() {
    ...
    var wasmTextFile = 'calc.wast';
    var wasmBinaryFile = 'calc.wasm';
    var asmjsCodeFile = 'calc.temp.asm.js';
...
;var FS = {
    ...
    createDefaultDevices: function () {
        ...
        if (typeof crypto !== 'undefined') {
            ...
            random_device = function () {
                abort("random_device"); /*Math.random() is not safe for random number generation, so this fallback random_device implementation aborts... see kripken/emscripten/pull/7096 */
            };
        }
